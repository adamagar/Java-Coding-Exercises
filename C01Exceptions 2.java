...
public class C01Exceptions {
    ...
    public static void findAndReadTheFile()
    {
        ...
        try {
            FileInputStream fis = new FileInputStream("/Users/barisemre/Desktop/testIntelliJ/Batch179/src/main/java/day20exceptions/MyFile.txt");
            ...
            System.out.println("The text om the file could not be read");
        } finally {
